...
local listfastattack = {'Normal','Medium','Super Fast'}
	...
	if getgenv().FastAttackFaiFao_Mode == "Fast Attack" then
		getgenv().Fast_Delay = 0.1
	elseif getgenv().FastAttackFaiFao_Mode == "Normal Attack" then
